      ...
      <div className="Container py-10 lg:w-10/12 mx-auto lg:px-20 px:6 w-full ">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <p className="policy-page-text">
            Village Food considers each of our customers to be a part of our
            family. Ensuring and encouraging the bond of trust with our
            customers, Village Food brings you the option to return products
            you received (if the product is damaged or mistakenly designed).
            In such cases, Village Food will provide you with fresh
          ...
          <p className="policy-page-text">
            ...
            <a href="mailto:yousufengineering2024@gmail.com" className="text-blue-600">
