...
export const metadata: Metadata = {
  title: "Village Food | Return Policy",
    ...
    <>
      ...
      <div className="policy-container text-gray-800 leading-relaxed  lg:px-20  px-6 lg:max-w-7xl w-full  mx-auto mt-24 ">
        ...
        <p>
          ...
          To uphold this bond of trust, Village Food offers you the option to return products you received
          <strong> if they are damaged or designed incorrectly.</strong>
          In such cases, Village Food will provide a fresh replacement.
        </p>
        ...
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>All returned products will undergo inspection by the Village Food team.</li>
          <li>
        ...
        <ol className="list-decimal ml-6 space-y-3">
          <li>
            Contact Village Food Customer Care at
            <a href="mailto:yousufengineering2024@gmail.com" className="text-blue-600 underline ml-1">
