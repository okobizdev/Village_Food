      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="w-full lg:w-1/3">
            <Image
              src={aboutImage}
              alt="Village Food apparel — shirts and polos"
          ...
          <div className="w-full lg:w-2/3">
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900">
              Village Food — Redefining Everyday Style
            </h1>

            <p className="mt-4 text-gray-700 leading-relaxed policy-page-text">
              Village Food is a modern e-commerce brand dedicated to delivering
            ...
            <p className="mt-6 text-gray-600">
              Driven by a passion for design and customer satisfaction, Village Food
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Shop Village Food collections"
              >
                Shop Collections
              </a>
              <a
                ...
                aria-label="Learn more about Village Food"
              >
                Learn More
              </a>
            </div>
