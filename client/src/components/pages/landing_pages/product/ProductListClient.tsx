      ...
      <div className="relative overflow-hidden lg:h-52 md:h-48 h-32">
        ...
        {isStockOut && (
          <div className="absolute top-0 left-0 w-20 h-20 overflow-hidden pointer-events-none z-20">
            <div className="bg-primary text-white font-bold text-[10px] px-8 py-1 -rotate-45 shadow-lg transform -translate-x-6 translate-y-3 text-center">
              STOCK OUT
            </div>
          </div>
        )}
        ...
        <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-center pb-2 gap-2 z-30">
          <button
            ...
            className="p-2 bg-white text-gray-800 rounded-full hover:bg-primary hover:text-white transition-all shadow-lg transform hover:scale-110"
            title="Quick View"
          >
          ...
          {!isStockOut && (
            <button
              ...
              className="p-2 bg-primary text-white rounded-full hover:bg-[#E55A00] transition-all shadow-lg transform hover:scale-110"
              title="Add to Cart"
            >
